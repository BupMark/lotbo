MASTER_CONTEXT.md — Version 4 juin 2026
...
2. CHIFFRES OFFICIELS — 31 mai 2026
...
✅ GM-REFONTE-TOTALE-1 — Classement unifié depuis transactions_points, Ma position corrigée, DB synchronisée
✅ UX-FORM-ALLDAY-1 — Checkbox "Toute la journée" dans /ajouter
...
Session 2–4 juin 2026

✅ MAP-CLUSTER-LIEU-1 — Clustering par lieu exact + spiderfy + pins SVG
✅ UX-PAGES-CONTENT-1 (partiel) — /evenement/[id] + /organisation/[slug] layout 2 colonnes desktop
✅ FEAT-CARTE-SOCIALE-1 — 4 nouveaux templates premium (Portrait, Story, Minimal, Badge VIP)
✅ TECH-WIKI-2 / FEAT-PROPOSE-MODIF-2 — Proposition correction étendue (pin, image, catégorie, heure, prix)
✅ FEAT-SCAN-RECURRENT-1 / FEAT-SCAN-MULTI-1 — Scan & Publie multi-événements (calendriers, programmes)
✅ FEAT-SHARE-DEEPLINK-1 — Routes courtes /e/ /u/ /b/ /o/ avec UTM
✅ FEAT-BIRTHDAY-COMMUNITY-1 — Anniversaires + ancienneté + CRON
✅ FEAT-ENQUETEUR-REFERRAL-1 — Bonus coordinateur CRON mensuel + email Brevo
✅ FEAT-ORG-COVER-1 — Upload cover organisation + position logo
✅ AUDIT-DEVEXPO-1 — PWA cache shell, headers optimisés, manifest screenshots
✅ Blog lotbo-landing — 1er article Histoire LOTBO + sidebar desktop


7. EN ATTENTE — PAR DIRECTION
🔴 Urgent

⏳ TECH-WIKI-1 — OSM fallback géocodage (bloque contacts WMF)
⏳ TECH-WIKI-3 — Couverture Paris période Wikimania (bloque contacts WMF)
...
⏳ GM-BADGE-WIKI1 — Badge "Contributeur Wikimedia" — gamification
...
🔴 TECH-WIKI-1 — OSM fallback géocodage (bloque contacts WMF) — URGENT
🔴 TECH-WIKI-3 — Couverture Paris période Wikimania — URGENT
🟡 UX-PAGES-CONTENT-1 suite — pages /evenements /classement /organisations hero visuel
🟡 SC-MONDIAL-FIFA-2 — Événements Coupe du Monde 16 villes — URGENT SEO
🟡 JACMEL2 — Formulaires enquête Jacmel en ligne
🟡 GM-BADGE-WIKI1 — Badge Contributeur Wikimedia
🟡 MAP-CLUSTER-LIEU-1 suite — bottom sheet liste événements même lieu
...
🔴 Priorité haute
CodeFeatureTECH-WIKI-1Intégration OSM fallback Google PlacesTECH-WIKI-3Couverture Paris période WikimaniaJACMEL2Formulaires enquête JacmelSC-MONDIAL-FIFA-2Événements Coupe du Monde 16 villesTECH-FILTER-WIKI-1Filtre Paris · Juillet 2026
🟡 Priorité moyenne
CodeFeatureGM-BADGE-WIKI1Badge Contributeur WikimediaUX-PAGES-CONTENT-1 suiteHero visuel /evenements /classement /organisationsMAP-CLUSTER-LIEU-1 suiteBottom sheet liste événements même lieuFEAT-SHARE-DEEPLINK-2URLs courtes /e/ /o/ — suite UTM
⚪ Phase 2
...
11. DÉCISIONS OFFICIELLES — 31 mai 2026
...
Prochaine mise à jour : samedi 6 juin 2026
Session 2–4 juin 2026 : MAP-CLUSTER-LIEU-1 · UX-PAGES-CONTENT-1 partiel · FEAT-CARTE-SOCIALE-1 · TECH-WIKI-2 · FEAT-SCAN-MULTI-1 · FEAT-SHARE-DEEPLINK-1 · FEAT-BIRTHDAY-COMMUNITY-1 · FEAT-ENQUETEUR-REFERRAL-1 · FEAT-ORG-COVER-1 · AUDIT-DEVEXPO-1 · Blog landing v1