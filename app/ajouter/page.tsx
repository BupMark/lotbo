...
const PAYS_VERS_FUSEAU: Record<string, string> = {
  ...
  'Dominican Republic': 'America/Santo_Domingo', 'République Dominicaine': 'America/Santo_Domingo', 'République dominicaine': 'America/Santo_Domingo',
  'Jamaica': 'America/Jamaica', 'Jamaïque': 'America/Jamaica',
  'Cuba': 'America/Havana',
  'Puerto Rico': 'America/Puerto_Rico', 'Porto Rico': 'America/Puerto_Rico',
  'Mexico': 'America/Mexico_City', 'Mexique': 'America/Mexico_City',
  'Colombia': 'America/Bogota', 'Colombie': 'America/Bogota',
  'Peru': 'America/Lima', 'Pérou': 'America/Lima',
  'Chile': 'America/Santiago', 'Chili': 'America/Santiago',
  'Argentina': 'America/Argentina/Buenos_Aires', 'Argentine': 'America/Argentina/Buenos_Aires',
  'Brazil': 'America/Sao_Paulo', 'Brésil': 'America/Sao_Paulo',
  'Bahamas': 'America/Nassau', 'The Bahamas': 'America/Nassau',
  'Trinidad and Tobago': 'America/Port_of_Spain', 'Trinité-et-Tobago': 'America/Port_of_Spain',
  'Barbados': 'America/Port_of_Spain', 'Barbade': 'America/Port_of_Spain',
  'Antigua and Barbuda': 'America/Port_of_Spain', 'Antigua-et-Barbuda': 'America/Port_of_Spain',
  'Dominica': 'America/Port_of_Spain', 'Dominique': 'America/Port_of_Spain',
  'Saint Lucia': 'America/Port_of_Spain', 'Sainte-Lucie': 'America/Port_of_Spain',
  'Saint Vincent and the Grenadines': 'America/Port_of_Spain', 'Saint-Vincent-et-les-Grenadines': 'America/Port_of_Spain',
  'Grenada': 'America/Port_of_Spain', 'Grenade': 'America/Port_of_Spain',
  'Saint Kitts and Nevis': 'America/Port_of_Spain', 'Saint-Kitts-et-Nevis': 'America/Port_of_Spain',
  'Venezuela': 'America/Caracas',
  'Guyana': 'America/Guyana',
  'Suriname': 'America/Paramaribo',
  'Paraguay': 'America/Asuncion',
  'Uruguay': 'America/Montevideo',
  'Ecuador': 'America/Guayaquil', 'Équateur': 'America/Guayaquil',
  'Panama': 'America/Panama',
  'Guatemala': 'America/Guatemala',
  'Belize': 'America/Guatemala',
  'El Salvador': 'America/Guatemala', 'Salvador': 'America/Guatemala',
  'Honduras': 'America/Tegucigalpa',
  'Nicaragua': 'America/Managua',
  'Costa Rica': 'America/Costa_Rica',
  'Bolivia': 'America/La_Paz', 'Bolivie': 'America/La_Paz',

  // — Europe — (EN + FR accentué/non-accentué)
  'United Kingdom': 'Europe/London', 'Royaume-Uni': 'Europe/London',
  'Ireland': 'Europe/Dublin', 'Irlande': 'Europe/Dublin',
  'Iceland': 'Atlantic/Reykjavik', 'Islande': 'Atlantic/Reykjavik',
  'France': 'Europe/Paris',
  'Belgium': 'Europe/Paris', 'Belgique': 'Europe/Paris',
  'Switzerland': 'Europe/Paris', 'Suisse': 'Europe/Paris',
  'Monaco': 'Europe/Paris',
  'Andorra': 'Europe/Paris', 'Andorre': 'Europe/Paris',
  'Luxembourg': 'Europe/Paris',
  'Germany': 'Europe/Berlin', 'Allemagne': 'Europe/Berlin',
  'Netherlands': 'Europe/Berlin', 'Pays-Bas': 'Europe/Berlin',
  'Italy': 'Europe/Berlin', 'Italie': 'Europe/Berlin',
  'Austria': 'Europe/Berlin', 'Autriche': 'Europe/Berlin',
  'Denmark': 'Europe/Berlin', 'Danemark': 'Europe/Berlin',
  'Norway': 'Europe/Berlin', 'Norvège': 'Europe/Berlin',
  'Czech Republic': 'Europe/Berlin', 'Czechia': 'Europe/Berlin', 'République tchèque': 'Europe/Berlin', 'Tchéquie': 'Europe/Berlin',
  'Slovakia': 'Europe/Berlin', 'Slovaquie': 'Europe/Berlin',
  'Hungary': 'Europe/Berlin', 'Hongrie': 'Europe/Berlin',
  'Croatia': 'Europe/Berlin', 'Croatie': 'Europe/Berlin',
  'Slovenia': 'Europe/Berlin', 'Slovénie': 'Europe/Berlin',
  'Serbia': 'Europe/Berlin', 'Serbie': 'Europe/Berlin',
  'Bosnia and Herzegovina': 'Europe/Berlin', 'Bosnie-Herzégovine': 'Europe/Berlin',
  'North Macedonia': 'Europe/Berlin', 'Macédoine du Nord': 'Europe/Berlin',
  'Albania': 'Europe/Berlin', 'Albanie': 'Europe/Berlin',
  'Malta': 'Europe/Berlin', 'Malte': 'Europe/Berlin',
  'San Marino': 'Europe/Berlin', 'Saint-Marin': 'Europe/Berlin',
  'Vatican City': 'Europe/Berlin', 'Vatican': 'Europe/Berlin',
  'Liechtenstein': 'Europe/Berlin',
  'Sweden': 'Europe/Stockholm', 'Suède': 'Europe/Stockholm',
  'Poland': 'Europe/Warsaw', 'Pologne': 'Europe/Warsaw',
  'Spain': 'Europe/Madrid', 'Espagne': 'Europe/Madrid',
  'Portugal': 'Europe/Lisbon',
  'Russia': 'Europe/Moscow', 'Russie': 'Europe/Moscow',
  'Belarus': 'Europe/Moscow', 'Biélorussie': 'Europe/Moscow',
  'Turkey': 'Europe/Istanbul', 'Turquie': 'Europe/Istanbul',
  'Greece': 'Europe/Athens', 'Grèce': 'Europe/Athens',
  'Romania': 'Europe/Bucharest', 'Roumanie': 'Europe/Bucharest',
  'Bulgaria': 'Europe/Bucharest', 'Bulgarie': 'Europe/Bucharest',
  'Finland': 'Europe/Helsinki', 'Finlande': 'Europe/Helsinki',
  'Ukraine': 'Europe/Kyiv',
  'Lithuania': 'Europe/Vilnius', 'Lituanie': 'Europe/Vilnius',
  'Latvia': 'Europe/Vilnius', 'Lettonie': 'Europe/Vilnius',
  'Estonia': 'Europe/Vilnius', 'Estonie': 'Europe/Vilnius',

  // — Afrique — (EN + FR accentué/non-accentué)
  "Côte d'Ivoire": 'Africa/Abidjan', 'Ivory Coast': 'Africa/Abidjan',
  'Senegal': 'Africa/Abidjan', 'Sénégal': 'Africa/Abidjan',
  'Mali': 'Africa/Abidjan', 'Burkina Faso': 'Africa/Abidjan',
  'Guinea': 'Africa/Abidjan', 'Guinée': 'Africa/Abidjan',
  'Guinea-Bissau': 'Africa/Abidjan', 'Guinée-Bissau': 'Africa/Abidjan',
  'Sierra Leone': 'Africa/Abidjan', 'Liberia': 'Africa/Abidjan',
  'Gambia': 'Africa/Abidjan', 'Gambie': 'Africa/Abidjan',
  'Mauritania': 'Africa/Abidjan', 'Mauritanie': 'Africa/Abidjan',
  'Togo': 'Africa/Abidjan',
  'Ghana': 'Africa/Accra',
  'Nigeria': 'Africa/Lagos',
  'Cameroon': 'Africa/Lagos', 'Cameroun': 'Africa/Lagos',
  'Gabon': 'Africa/Lagos',
  'Chad': 'Africa/Lagos', 'Tchad': 'Africa/Lagos',
  'Central African Republic': 'Africa/Lagos', 'République centrafricaine': 'Africa/Lagos',
  'Republic of the Congo': 'Africa/Lagos', 'Congo': 'Africa/Lagos', 'Congo-Brazzaville': 'Africa/Lagos',
  'Equatorial Guinea': 'Africa/Lagos', 'Guinée équatoriale': 'Africa/Lagos',
  'Niger': 'Africa/Lagos',
  'Benin': 'Africa/Lagos', 'Bénin': 'Africa/Lagos',
  'Angola': 'Africa/Luanda',
  'Tunisia': 'Africa/Tunis', 'Tunisie': 'Africa/Tunis',
  'Algeria': 'Africa/Tunis', 'Algérie': 'Africa/Tunis',
  'Libya': 'Africa/Tunis', 'Libye': 'Africa/Tunis',
  'Democratic Republic of the Congo': 'Africa/Kinshasa', 'DR Congo': 'Africa/Kinshasa', 'Congo (RDC)': 'Africa/Kinshasa', 'République démocratique du Congo': 'Africa/Kinshasa',
  'Kenya': 'Africa/Nairobi',
  'Ethiopia': 'Africa/Nairobi', 'Éthiopie': 'Africa/Nairobi',
  'Tanzania': 'Africa/Nairobi', 'Tanzanie': 'Africa/Nairobi',
  'Uganda': 'Africa/Nairobi', 'Ouganda': 'Africa/Nairobi',
  'South Sudan': 'Africa/Nairobi', 'Soudan du Sud': 'Africa/Nairobi',
  'Madagascar': 'Africa/Nairobi',
  'Comoros': 'Africa/Nairobi', 'Comores': 'Africa/Nairobi',
  'Rwanda': 'Africa/Kigali', 'Burundi': 'Africa/Kigali',
  'Somalia': 'Africa/Mogadishu', 'Somalie': 'Africa/Mogadishu',
  'Djibouti': 'Africa/Mogadishu',
  'Eritrea': 'Africa/Mogadishu', 'Érythrée': 'Africa/Mogadishu',
  'Morocco': 'Africa/Casablanca', 'Maroc': 'Africa/Casablanca',
  'Egypt': 'Africa/Cairo', 'Égypte': 'Africa/Cairo',
  'Sudan': 'Africa/Khartoum', 'Soudan': 'Africa/Khartoum',
  'South Africa': 'Africa/Johannesburg', 'Afrique du Sud': 'Africa/Johannesburg',
  'Zimbabwe': 'Africa/Johannesburg', 'Botswana': 'Africa/Johannesburg',
  'Lesotho': 'Africa/Johannesburg',
  'Eswatini': 'Africa/Johannesburg', 'Swaziland': 'Africa/Johannesburg',
  'Mozambique': 'Africa/Maputo',
  'Zambia': 'Africa/Maputo', 'Zambie': 'Africa/Maputo',
  'Malawi': 'Africa/Maputo',
  'Namibia': 'Africa/Windhoek', 'Namibie': 'Africa/Windhoek',
  'Reunion': 'Indian/Reunion', 'Réunion': 'Indian/Reunion',
  'Mauritius': 'Indian/Reunion', 'Maurice': 'Indian/Reunion',
  'Seychelles': 'Indian/Reunion',

  // — Asie — (EN + FR accentué/non-accentué)
  'Lebanon': 'Asia/Beirut', 'Liban': 'Asia/Beirut',
  'Jordan': 'Asia/Amman', 'Jordanie': 'Asia/Amman',
  'Syria': 'Asia/Amman', 'Syrie': 'Asia/Amman',
  'Israel': 'Asia/Jerusalem', 'Israël': 'Asia/Jerusalem',
  'Palestine': 'Asia/Jerusalem',
  'Cyprus': 'Asia/Nicosia', 'Chypre': 'Asia/Nicosia',
  'Iraq': 'Asia/Baghdad', 'Irak': 'Asia/Baghdad',
  'Saudi Arabia': 'Asia/Riyadh', 'Arabie saoudite': 'Asia/Riyadh',
  'Kuwait': 'Asia/Riyadh', 'Koweït': 'Asia/Riyadh',
  'Yemen': 'Asia/Riyadh', 'Yémen': 'Asia/Riyadh',
  'Qatar': 'Asia/Qatar',
  'Bahrain': 'Asia/Qatar', 'Bahreïn': 'Asia/Qatar',
  'United Arab Emirates': 'Asia/Dubai', 'Émirats arabes unis': 'Asia/Dubai',
  'Oman': 'Asia/Dubai',
  'Iran': 'Asia/Tehran',
  'Afghanistan': 'Asia/Kabul',
  'Pakistan': 'Asia/Karachi',
  'Maldives': 'Asia/Karachi',
  'Uzbekistan': 'Asia/Tashkent', 'Ouzbékistan': 'Asia/Tashkent',
  'Tajikistan': 'Asia/Tashkent', 'Tadjikistan': 'Asia/Tashkent',
  'Turkmenistan': 'Asia/Tashkent', 'Turkménistan': 'Asia/Tashkent',
  'Kyrgyzstan': 'Asia/Almaty', 'Kirghizistan': 'Asia/Almaty',
  'Kazakhstan': 'Asia/Almaty',
  'India': 'Asia/Kolkata', 'Inde': 'Asia/Kolkata',
  'Sri Lanka': 'Asia/Kolkata',
  'Nepal': 'Asia/Kathmandu', 'Népal': 'Asia/Kathmandu',
  'Bangladesh': 'Asia/Dhaka',
  'Bhutan': 'Asia/Dhaka', 'Bhoutan': 'Asia/Dhaka',
  'Myanmar': 'Asia/Yangon', 'Burma': 'Asia/Yangon', 'Birmanie': 'Asia/Yangon',
  'Thailand': 'Asia/Bangkok', 'Thaïlande': 'Asia/Bangkok',
  'Vietnam': 'Asia/Bangkok', 'Viêt Nam': 'Asia/Bangkok',
  'Cambodia': 'Asia/Bangkok', 'Cambodge': 'Asia/Bangkok',
  'Laos': 'Asia/Bangkok',
  'Singapore': 'Asia/Singapore', 'Singapour': 'Asia/Singapore',
  'Malaysia': 'Asia/Singapore', 'Malaisie': 'Asia/Singapore',
  'Philippines': 'Asia/Singapore',
  'Brunei': 'Asia/Singapore',
  'Indonesia': 'Asia/Jakarta', 'Indonésie': 'Asia/Jakarta',
  'China': 'Asia/Shanghai', 'Chine': 'Asia/Shanghai',
  'Hong Kong': 'Asia/Shanghai',
  'Taiwan': 'Asia/Shanghai', 'Taïwan': 'Asia/Shanghai',
  'Mongolia': 'Asia/Ulaanbaatar', 'Mongolie': 'Asia/Ulaanbaatar',
  'South Korea': 'Asia/Seoul', 'Corée du Sud': 'Asia/Seoul',
  'North Korea': 'Asia/Seoul', 'Corée du Nord': 'Asia/Seoul',
  'Japan': 'Asia/Tokyo', 'Japon': 'Asia/Tokyo',
  'Azerbaijan': 'Asia/Baku', 'Azerbaïdjan': 'Asia/Baku',
  'Georgia': 'Asia/Baku', 'Géorgie': 'Asia/Baku',
  'Armenia': 'Asia/Baku', 'Arménie': 'Asia/Baku',

  // — Océanie — (EN + FR accentué/non-accentué)
  'New Zealand': 'Pacific/Auckland', 'Nouvelle-Zélande': 'Pacific/Auckland',
  'Fiji': 'Pacific/Fiji', 'Fidji': 'Pacific/Fiji',
  'Papua New Guinea': 'Pacific/Port_Moresby', 'Papouasie-Nouvelle-Guinée': 'Pacific/Port_Moresby',
  'Solomon Islands': 'Pacific/Port_Moresby', 'Îles Salomon': 'Pacific/Port_Moresby',
}
    ...
    if (suggestion.place_id) {
      try {
        ...
        if (loc) {
          ...
          if (!fuseauModifieManuellement && paysComp?.long_name) {
            const tz = PAYS_VERS_FUSEAU[paysComp.long_name]
