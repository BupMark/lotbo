        ...
        <div style={{ padding: isDesktop ? '40px 48px 80px' : '24px 16px 64px', maxWidth: isDesktop ? '100%' : 680, margin: isDesktop ? 0 : '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, marginBottom: 32 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              <a href={'https://twitter.com/intent/tweet?text=' + encodeURIComponent('Découvre cet événement sur Lotbo : ' + ev.titre) + '&url=' + encodeURIComponent(urlEvenement)} target="_blank" onClick={() => trackerPartage('x')} title="X" style={{ width: 38, height: 38, borderRadius: '50%', background: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', flexShrink: 0 }}>
