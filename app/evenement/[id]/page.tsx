    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-2xl mx-auto p-8">
        ...
        <div className="flex flex-col gap-3 text-gray-300 mb-8">
          ...
          {ev.heure_fin && <p>⏰ <span className="text-white">Fin à {ev.heure_fin}</span></p>}
        </div>
        ...
        {ev.lien && (
          <a href={ev.lien} target="_blank"
            className="block w-full text-center bg-green-600 hover:bg-green-500 text-white font-bold py-4 rounded-xl">
            🔗 Plus de détails
          </a>
        )}
